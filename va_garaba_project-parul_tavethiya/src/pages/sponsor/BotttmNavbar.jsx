...
const BotttmNavbar = () => {
   ...
   const handleNavigation = (link)=>{
       navigate(link);
        ...
        const homeLink="/role/sponsor"
        const ticketLink="/role/sponsor/pass"
        const notificationLink="/role/sponsor/notification-page"
        const profileLink="/role/sponsor/profile"
